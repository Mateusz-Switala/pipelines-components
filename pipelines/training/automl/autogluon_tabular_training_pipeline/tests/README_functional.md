...
7. Measure total size of AutoGluon predictor artifacts in S3.
8. Write the scenario result to a per-scenario JSON file (xdist-safe).
9. Assert the run succeeded, completed in under 1 hour, and produced at least
    ...
    "models": [
      {
        ...
        "metrics": {"r2": 0.92, "rmse": 15234.5}
      }
    ],
    "total_model_size_bytes": 1048576,
    "total_model_size_mb": 1.0,
    "config": { "..." }
  },
  "TC-A-2_binary_churn": { "..." }
}
